...
{% block title %}Master Kode Perkiraan
{% endblock %}
{% block content %}
<style>
						...
						<table id="datatable" class="table table-bordered border-0 w-100 table-striped-secondary text-dark-m1 mb-0">
							<thead>
								<tr class="bgc-info text-white text-center brc-black-tp10">
									...
									{# <th style="vertical-align: middle;">Induk</th> #}
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Kode Perkiraan</h4>
					...
					<div class="modal-body">
						...
						<div class="row form-group">
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 200px;">Kelompok</span>
									</div>
									<select name="kelompok" id="kelompok" class="select2 select2Kelompok"  ></select>
								</div>
							</div>
						</div>
					</div>
	...
	<div id="filterModal" class="modal fade" role="dialog">
		<div class="modal-dialog radius-4">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Kode Perkiraan</h4>
					<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
...
{% block inline_script %}
<script>
	{% include 'Defaults/Master/ReferensiData/KodePerkiraan/index.js' %}
</script>
{% endblock %}