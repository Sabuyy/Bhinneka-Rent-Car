...
{% block title %}Master Kelompok Bagian
{% endblock %}
{% block content %}
<style>
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Kelompok Bagian</h4>
				...
				<form class="form-horizontal" action="javascript:;">
					<div class="modal-body">
						...
						<div class="row form-group select-is-aktif">
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 200px;">Status</span>
									</div>
	...
	<div id="filterModal" class="modal fade" role="dialog">
		<div class="modal-dialog radius-4">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Kelompok Bagian</h4>
					<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					...
					<form class="form-horizontal" id="form-filter">
						...
						<div class="input-group mb-2 input-filter">
							...
							<input type="text" name="search_kelompok" class="form-control" disabled="">
						</div>
                        ...
                        <div class="input-group mb-2 input-filter">
                            ...
                            <select name="search_is_aktif" id="search_is_aktif" disabled="" class="form-control">
								<option value="1">Aktif</option>
...
{% block inline_script %}
<script>
	{% include 'Defaults/Master/ReferensiData/KelompokSatuanKerja/index.js' %}
</script>
{% endblock %}