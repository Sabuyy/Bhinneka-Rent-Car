...
{% block title %}Master Kode Perkiraan Kelompok
{% endblock %}
{% block content %}
<style>
	...
	<div class="card ccard ">
		...
		border-top-right-radius: 0.4rem;border-bottom: 1px solid #e0e5e8 !important;" >
			<h4 class="card-title text-dark-m3 mt-2">
				Master - Kode Perkiraan Kelompok
			</h4>
			<div class="page-tools mt-3 mt-sm-0 mb-sm-n1 card-toolbar">
				...
				<a href="#" class="btn mr-1 btn-info mb-2 radius-2" id="btn-sinkron">
					<i class="fa fa-database text-110 align-text-bottom mr-2"></i>
					Sinkron
				</a>
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Kode Perkiraan Kelompok</h4>
	...
	<div id="filterModal" class="modal fade" role="dialog">
		<div class="modal-dialog radius-4">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Kode Perkiraan Kelompok</h4>
					<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
...
{% block inline_script %}
<script>
	{% include 'Defaults/Master/ReferensiData/KodePerkiraanKelompok/index.js' %}
</script>
{% endblock %}