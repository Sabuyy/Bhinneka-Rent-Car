...
{% block title %}Master Kode Perkiraan Bagian
{% endblock %}
{% block content %}
<style>
...
<div class="page-content" >
	<div class="card ccard mx-auto" style="width: 98%; position: sticky;">
                ...
                <div class="col-sm-12" style="margin-bottom : 3px;">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" style="width: 100px;">Bagian</span>
                        </div>
                        <select name="satuankerja" id="satuankerja" class="select2 select2satuankerja"  ></select>
                    </div>
                </div>
            </div>
			<div class="row">
				<div class="col-md-12" id="message-awal">
					<center><h4>Pilih Bagian Terlebih Dahulu</h4></center>
				</div>
				<div class="col-md-12">
						...
						<table id="datatable" class="table table-bordered border-0 w-100 table-striped-secondary text-dark-m1 mb-0">
							<thead>
								<tr class="bgc-info text-white text-center brc-black-tp10">
									<th style="vertical-align: middle;"><input type="checkbox" id="check_all"></th>
		...
		<div class="card-footer p-0">
            <div class="mt-2 mb-2 mr-2" style="float: right;">
                <button type="button" class="btn btn-success px-3 py-25 text-125 mb-1" id="btn_simpanData">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Kode Perkiraan Satuan Kerja</h4>
					...
					<div class="modal-body">
						...
						<div class="row form-group">
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 200px;">Kode</span>
									</div>
						...
						<div class="row form-group">
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 200px;">Nama</span>
									</div>
						...
						<div class="row form-group">
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 200px;">Induk</span>
									</div>
									<select name="induk" id="induk" class="select2 select2induk"  ></select>
								</div>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 200px;">Golongan</span>
									</div>
									<select name="golongan" id="golongan" class="select2 select2golongan"  ></select>
								</div>
							</div>
						</div>
	...
	<div id="filterModal" class="modal fade" role="dialog">
		<div class="modal-dialog radius-4">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Kode Perkiraan Satuan Kerja</h4>
					<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					...
					<form class="form-horizontal" id="form-filter">
                        ...
                        <div class="input-group mb-2 input-filter">
                            ...
                            <select name="search_id_induk" id="search_id_induk" class="select2 select2induk" disabled=""></select>
						</div>
...
{% block inline_script %}
<script>
	{% include 'Defaults/Master/ReferensiData/KodePerkiraanSatuanKerja/index.js' %}
</script>
{% endblock %}