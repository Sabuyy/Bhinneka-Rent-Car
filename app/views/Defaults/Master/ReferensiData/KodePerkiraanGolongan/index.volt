...
{% block title %}Master Kode Perkiraan Golongan
{% endblock %}
{% block content %}
<style>
	...
	<div class="card ccard mx-auto" style="width: 98%; position: sticky;">
		...
		border-top-right-radius: 0.4rem;border-bottom: 1px solid #e0e5e8 !important;" >
			<h4 class="card-title text-dark-m3 mt-2">
				Master - Kode Perkiraan Golongan
			</h4>
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Kode Perkiraan Golongan</h4>
								...
								<div class="input-group  input-filter">
									<div class="input-group-prepend" style="width : 10% !important">
										<span class="input-group-text">
											<input type="checkbox" id="checkbox-induk" class="ace-switch">
										</span>
									</div>
									<div class="input-group-prepend" style="max-width: 100px;">
										<span class="input-group-text" >Induk</span>
									</div>
									<select name="id_induk" id="id_induk" class="select2 select2induk" disabled=""></select>
								</div>
							</div>
						</div>
					</div>
	...
	<div id="filterModal" class="modal fade" role="dialog">
		<div class="modal-dialog radius-4">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Kode Perkiraan Golongan</h4>
					<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
...
{% block inline_script %}
<script>
	{% include 'Defaults/Master/ReferensiData/KodePerkiraanGolongan/index.js' %}
</script>
{% endblock %}
