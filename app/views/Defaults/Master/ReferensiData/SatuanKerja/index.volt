			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Bagian</h4>
					...
					<div class="modal-body">
							...
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 150px;">Kelompok</span>
									</div>
                                    <select name="id_kelompok" id="id_kelompok" class="select2 select2kelompok" placeholder="Kelompok"></select>
								</div>
							</div>
						</div>
						<div class="row form-group">
						...
						<div class="row form-group">
							<div class="col-sm-12" style="margin-bottom : 5px;">
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" style="width: 150px;">Long Kode</span>
									</div>
									<input type="text" id="long_kode" name="long_kode" class="form-control" required>
								</div>
							</div>
						</div>
						<div class="row form-group">
	...
	<div id="filterModal" class="modal fade" role="dialog">
		<div class="modal-dialog radius-4">
			...
			<div class="modal-content radius-4">
				<div class="modal-header bgc-primary radius-t-4">
					<h4 class="modal-title text-white">
						<i class="fa fa-search text-white"></i>&nbsp;&nbsp; Pencarian - Bagian</h4>
					<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					...
					<form class="form-horizontal" id="form-filter">
                        ...
                        <div class="input-group mb-2 input-filter">
                            ...
                            <select name="search_id_kelompok" id="search_id_kelompok" class="select2 select2kelompok" disabled=""></select>
						</div>
...
{% block inline_script %}
<script>
	{% include 'Defaults/Master/ReferensiData/SatuanKerja/index.js' %}
</script>
{% endblock %}
