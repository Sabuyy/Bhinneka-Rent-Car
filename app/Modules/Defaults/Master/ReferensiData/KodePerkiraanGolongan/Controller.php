...
namespace App\Modules\Defaults\Master\ReferensiData\KodePerkiraanGolongan;
...
use App\Modules\Defaults\Master\ReferensiData\KodePerkiraanGolongan\Model as DefaultModel;
use App\Modules\Defaults\Master\ReferensiData\KodePerkiraanGolongan\ModelView as ViewModel;

/**
 * @routeGroup("/master/referensi-data/kode-perkiraan-golongan")
 */
class Controller extends MiddlewareHardController
{
    ...
    public function createAction()
    {
        ...
        $parent = Request::getPost('id_induk');
        ...
        $log = new Log(); 
        $log->write("Insert Data Master-Referensi Data-Kode Perkiraan Golongan", $data, $result, "App\Modules\Defaults\Master\ReferensiData\KodePerkiraanGolongan\Controller", "INSERT");
    ...
    public function updateAction()
    {
        ...
        $log = new Log(); 
        $log->write("Update Data Master-Referensi Data-Kode Perkiraan Golongan", $data, $result, "App\Modules\Defaults\Master\ReferensiData\KodePerkiraanGolongan\Controller", "UPDATE");
    ...
    public function deleteAction()
    {
        ...
        $log = new Log(); 
        $log->write("Delete Data Master-Referensi Data-Kode Perkiraan Golongan", ['id'=>$id], $result, "App\Modules\Defaults\Master\ReferensiData\KodePerkiraanGolongan\Controller", "DELETE");
    ...
    public function sinkronAction()
    {
        ...
        $query = "CALL sp_singkron_akun_golongan($pdam_id)";
